...
;;;;
;;; Global variables: humans, birds and mosquitoes are breeds
;;;;
...
; the season is hypothesized to start on June 1 and run until October 1 (120 days)
  ...
  create-robins Number-of-Robins - Infected-Robins
  [
    setxy random-xcor random-ycor
    set size 1
    set robins-sig 40
...
"Infected Robins" 1.0 0 -1184463 true "" "if ticks > 0 and ticks < 120 [ plot count robins with [ state = \"infected\" ]]"
...
true
0
Polygon -7500403 true true 195 150 105 150 90 165 90 225 105 270 135 300 165 300 195 270 210 225 210 165 195 150
...
false
6
Polygon -7500403 true false 64 89 16 105 68 109 68 91 66 89
Polygon -13345367 true false 60 85 80 69 98 69 120 75 136 89 134 113 124 137 150 161 208 191 242 209 240 243 170 253 100 245 64 203 52 155 78 133 54 109 60 85 60 91 62 89 62 89
